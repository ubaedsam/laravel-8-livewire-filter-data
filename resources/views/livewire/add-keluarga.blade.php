  ...
  <body>
    <div class="container">
        <div class="mx-auto mt-4">
            ...
            <form wire:submit.prevent="createKeluarga" autocomplete="off">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" wire:model.defer="state.kk_id">
                        <option selected>Pilih Nama Kepala Keluarga</option>
                        @foreach ($kkeluargas as $kkeluarga)
                        <option value="{{ $kkeluarga->id }}">{{ $kkeluarga->name }}</option>
                        @endforeach
                    </select>
                </div>
